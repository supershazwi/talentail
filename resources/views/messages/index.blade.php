...
@section ('content')
    <div class="row" style="margin-top: 25px;">
       	<div class="chat-module" data-filter-list="chat-module-body" style="padding: 0 1.5rem 0 1.5rem; height: 100vh;">
           <div class="chat-module-top">
           		...
           		<div class="chat-module-body" style="padding-right: 0;">
           ...
           <div class="chat-module-bottom" style="background: none;">
        ...
        <div class="sidebar collapse" id="sidebar-collapse" style="height: 100vh; border: 1px solid #E9EEF2;">
