  ...
  <div class="container">
    <div class="row">
      <div class="col-12 col-lg-12">
        ...
        <!-- Form -->
          <form method="POST" action="/blog/posts/{{$post->id}}/update" class="mb-4" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" name="title" class="form-control" id="title" placeholder="Enter title" value="{{$post->title}}" autofocus>
          </div>
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="notes" id="notes" rows="5" placeholder="Enter notes" style="resize: none;">{{ $post->notes }}</textarea>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="tags" class="form-control" id="tags" placeholder="Enter tags comma separated. e.g. startup, inception, hustle, ..." value="{{ $post->tags }}" autofocus>
          </div>
